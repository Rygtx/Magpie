Magpie Experimental v0.6.7-beta4 x64

安装或升级
从托盘完全退出 Magpie，将 Magpie-Experimental-x64 v0.6.7-beta4.zip 完整解压到新目录，再运行其中的 Magpie.exe。
...
Install or upgrade
Fully exit Magpie from the system tray, extract Magpie-Experimental-x64 v0.6.7-beta4.zip completely into a new folder, then run its Magpie.exe.
