...
当前本地工作为 `0.6.7` 分支的 `067 local`，持续覆盖同一运行目录。下一轮规划：[067 r2 TODO](todos/20260908-v0.6.7-r2-TODO.md) 与 [DLSS 管线/官方文档 review](reviews/20260908-v0.6.7-r2-dlss-pipeline-review.md)，目前仅完成调查，尚未修改实现。此前入口：[r1 fix1 执行清单](todos/20260908-v0.6.7-r1-fix1-TODO.md)、[效果器选择器与参数测试](testing/EFFECT-PICKER.md)、[本地构建约定](GIT-WORKFLOW.md)。下面的 0.6.6 与更早发布条目保留历史。
