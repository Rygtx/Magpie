...
当前本地测试候选：[0.6.7 Beta 2 修复说明](../RELEASE_NOTES_v0.6.7-beta2.md)，版本标识为 `0.6.7-beta2`，完整包位于独立的 `release/v0.6.7-beta2/`；日常迭代仍覆盖 `067 local`。此前 [Beta 1 功能变化](../RELEASE_NOTES_v0.6.7-beta1.md)、[0.6.6](../RELEASE_NOTES_v0.6.6-experimental.md) 与 [0.6.5](../RELEASE_NOTES_v0.6.5-experimental.md) 的发布说明保留历史。
